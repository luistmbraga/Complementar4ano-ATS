...
genEmailP = do nome <- elements Nomes.listaNomes   
               ...
               mail <- frequency [(100, return "@gmail.com")]--frequency [(60, return "@gmail.com"),(20,return "@hotmail.com"),(10,return "@yahoo.com"),(5,return "@outlook.com"),(5,return "@sapo.pt")] 
...
genLogs nProps nClientes nCarros nAlugueres nClassifs  = 
                          do props     <- vectorOf nProps genNovoProp
                             ...
                             carros    <- vectorOf nCarros $ genNovoCarro nifsP
