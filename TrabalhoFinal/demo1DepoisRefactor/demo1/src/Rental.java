...
public class Rental implements Serializable {
    ...
    private static final String HORAS = "%.2f Horas";   // introduzido para evitar repetir a string 3 vezes
    ...
    public String toString() {
        ...
        str.append("Tempo Estimado: ").append(String.format(HORAS, this.expectedTime)).append("\n");
    ...
    public String toFinalString() {
        StringBuilder str = new StringBuilder();
        str.append("Tempo Total: ").append(String.format(HORAS, this.realTime)).append("\n");
