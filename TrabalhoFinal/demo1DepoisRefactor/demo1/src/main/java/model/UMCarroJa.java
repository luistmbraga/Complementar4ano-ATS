...
public class UMCarroJa implements Serializable {
    ...
    // smell tinha parentises no e a seguir ao toMap
    ...
    // smell tem mais parâmetros do que o aceitável mas não dá para corrigir
    ...
    // smell tem mais parâmetros que o aceitável mas não dá para corrigir
    ...
    // SEM BLOCKER ASSIM, CLOSE OBJECT OUTPUT COM TRY WITH RESOURCE -> https://stackoverflow.com/questions/47397157/how-to-close-objectinputstream-properly
    // smell -> close feito automaticamente com try with resource logo removeu-se
    public static UMCarroJa read(String fName) throws IOException, ClassNotFoundException {
        UMCarroJa u = new UMCarroJa();
        try (FileInputStream r = new FileInputStream(fName);
