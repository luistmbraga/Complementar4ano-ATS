        ...
        while(this.menu.getRun()) {
            ...
            switch (menu.getMenu()) {
                case Login:
                    ...
                    catch (WrongPasswordExecption e){ error = "Invalid Password"; e.printStackTrace();} catch (IOException e) {
                        e.printStackTrace();
                    }
                    break;
                case RegisterClient:
                    ...
                    catch (UserExistsException e){ error = "Utilizador já existe"; e.printStackTrace();} catch (IOException e) {
                        e.printStackTrace();
                    }
                    break;
                case RegisterOwner:
                ...
                case Closest:
                    ...
                    catch (InvalidNewRentalException e){error = "Novo Rental inválido"; e.printStackTrace();} catch (IOException e) {
                        e.printStackTrace();
                    }
                    break;
                case Cheapest:
                ...
                case CheapestNear:
                    ...
                    catch (NoCarAvaliableException e)  {error = "No cars availables"; e.printStackTrace();} catch (IOException e) {
                        e.printStackTrace();
                    }
                    break;
                ...
                case Specific:
                    ...
                    catch (InvalidNewRentalException e) { error = "Invalid Parameters"; e.printStackTrace();} catch (IOException e) {
                        e.printStackTrace();
                    }
                    break;
                ...
                case AddCar:
                    ...
                    catch (InvalidUserException ignored) {} catch (IOException e) {
                        e.printStackTrace();
                    }
                    break;
